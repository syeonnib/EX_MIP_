...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/kangsuyeon/MIP/src/mip_auton_2022_review/src/controller/control)
  set(control_DEVEL_PREFIX /home/kangsuyeon/MIP/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/kangsuyeon/MIP/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'mipev <king@g.seoultech.ac.kr>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kangsuyeon/MIP/src/mip_auton_2022_review/src/controller/control/${idir}'.  ${_report}")
    endif()
