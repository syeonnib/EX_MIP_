...
"""autogenerated by genpy from autoware_map_msgs/LaneChangeRelationArray.msg. Do not edit."""
import codecs
import sys
...
class LaneChangeRelationArray(genpy.Message):
  _md5sum = "329b4e9aa6f696f62fd90636a3f80778"
  _type = "autoware_map_msgs/LaneChangeRelationArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This consists of multiple LaneChangeRelation objects in a map. 
...
"""
  ...
  _slot_types = ['std_msgs/Header','autoware_map_msgs/LaneChangeRelation[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LaneChangeRelationArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autoware_map_msgs.msg.LaneChangeRelation()
        _x = val1
        start = end
        end += 12
