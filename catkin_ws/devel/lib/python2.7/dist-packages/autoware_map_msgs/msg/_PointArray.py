...
"""autogenerated by genpy from autoware_map_msgs/PointArray.msg. Do not edit."""
import codecs
import sys
...
class PointArray(genpy.Message):
  _md5sum = "f0412fc1ae8fe89a090b50a916f14ba1"
  _type = "autoware_map_msgs/PointArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This consists of multiple Point objects in a map. 
...
"""
  ...
  _slot_types = ['std_msgs/Header','autoware_map_msgs/Point[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autoware_map_msgs.msg.Point()
        _x = val1
        start = end
        end += 36
        ...
        if python3:
          val1.pcd = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.pcd = str[start:end]
        _x = val1
        start = end
        end += 16
