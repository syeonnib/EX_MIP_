...
"""autogenerated by genpy from vector_map_msgs/Point.msg. Do not edit."""
import codecs
import sys
...
class Point(genpy.Message):
  _md5sum = "4d106503a62bbb6b76e4aefe8ac868a9"
  _type = "vector_map_msgs/Point"
...
int32 mcode3
"""
  __slots__ = ['pid','b','l','h','bx','ly','ref','mcode1','mcode2','mcode3']
  _slot_types = ['int32','float64','float64','float64','float64','float64','int32','int32','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.ref is None:
        self.ref = 0
      if self.mcode1 is None:
        self.mcode1 = 0
      if self.mcode2 is None:
        self.mcode2 = 0
      if self.mcode3 is None:
        self.mcode3 = 0
    else:
      self.pid = 0
      self.b = 0.
