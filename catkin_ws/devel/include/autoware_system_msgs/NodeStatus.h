...
struct NodeStatus_
{
  ...
  _node_activated_type node_activated;
   ...
   typedef std::vector< ::autoware_system_msgs::DiagnosticStatusArray_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_system_msgs::DiagnosticStatusArray_<ContainerAllocator> >> _status_type;
  _status_type status;
