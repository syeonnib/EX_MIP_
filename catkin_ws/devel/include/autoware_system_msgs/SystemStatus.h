...
struct SystemStatus_
{
  ...
  _header_type header;
   ...
   typedef std::vector<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>> _available_nodes_type;
  ...
  _detect_too_match_warning_type detect_too_match_warning;
   ...
   typedef std::vector< ::autoware_system_msgs::NodeStatus_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_system_msgs::NodeStatus_<ContainerAllocator> >> _node_status_type;
  _node_status_type node_status;

   typedef std::vector< ::autoware_system_msgs::HardwareStatus_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_system_msgs::HardwareStatus_<ContainerAllocator> >> _hardware_status_type;
  _hardware_status_type hardware_status;

   typedef std::vector< ::rosgraph_msgs::TopicStatistics_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::rosgraph_msgs::TopicStatistics_<ContainerAllocator> >> _topic_statistics_type;
...
struct Printer< ::autoware_system_msgs::SystemStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_system_msgs::SystemStatus_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.available_nodes.size(); ++i)
    {
      ...
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.available_nodes[i]);
    }
