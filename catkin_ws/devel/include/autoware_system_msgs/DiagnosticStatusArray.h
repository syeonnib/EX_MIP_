...
struct DiagnosticStatusArray_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::autoware_system_msgs::DiagnosticStatus_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_system_msgs::DiagnosticStatus_<ContainerAllocator> >> _status_type;
  _status_type status;
