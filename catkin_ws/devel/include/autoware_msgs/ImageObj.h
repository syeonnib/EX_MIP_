...
struct ImageObj_
{
  ...
  _type_type type;
   ...
   typedef std::vector< ::autoware_msgs::ImageRect_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_msgs::ImageRect_<ContainerAllocator> >> _obj_type;
  _obj_type obj;
