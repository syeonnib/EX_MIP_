...
struct LaneArray_
{
  ...
  _id_type id;
   ...
   typedef std::vector< ::autoware_msgs::Lane_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_msgs::Lane_<ContainerAllocator> >> _lanes_type;
  _lanes_type lanes;
