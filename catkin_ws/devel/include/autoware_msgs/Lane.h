...
struct Lane_
{
  ...
  _lane_id_type lane_id;
   ...
   typedef std::vector< ::autoware_msgs::Waypoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_msgs::Waypoint_<ContainerAllocator> >> _waypoints_type;
