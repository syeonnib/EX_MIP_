...
struct PointsImage_
{
  ...
  _intensity_type intensity;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _min_height_type;
  _min_height_type min_height;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _max_height_type;
