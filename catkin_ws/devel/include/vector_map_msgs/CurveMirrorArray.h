...
struct CurveMirrorArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::vector_map_msgs::CurveMirror_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::vector_map_msgs::CurveMirror_<ContainerAllocator> >> _data_type;
  _data_type data;
