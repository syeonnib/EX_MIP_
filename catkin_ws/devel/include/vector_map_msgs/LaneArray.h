...
struct LaneArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::vector_map_msgs::Lane_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::vector_map_msgs::Lane_<ContainerAllocator> >> _data_type;
  _data_type data;
