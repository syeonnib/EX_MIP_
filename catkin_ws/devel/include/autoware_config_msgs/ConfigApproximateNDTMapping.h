...
bool operator==(const ::autoware_config_msgs::ConfigApproximateNDTMapping_<ContainerAllocator1> & lhs, const ::autoware_config_msgs::ConfigApproximateNDTMapping_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.max_submap_size == rhs.max_submap_size;
}
