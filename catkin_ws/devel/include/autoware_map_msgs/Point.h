...
struct Point_
{
  ...
  _epsg_type epsg;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _pcd_type;
  _pcd_type pcd;
...
struct Printer< ::autoware_map_msgs::Point_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_map_msgs::Point_<ContainerAllocator>& v)
  {
    ...
    s << indent << "pcd: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.pcd);
    s << indent << "lat: ";
