...
struct WaypointArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::autoware_map_msgs::Waypoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::autoware_map_msgs::Waypoint_<ContainerAllocator> >> _data_type;
  _data_type data;
